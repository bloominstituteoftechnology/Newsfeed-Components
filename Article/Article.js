...
function createNewArticle(title, date, p1, p2, p3) {
  ...
  articleC.appendChild(firstParagraph);
  articleC.appendChild(secondParagraph);
  articleC.appendChild(thirdParagraph);
...
articleData.forEach(data => {
  articlesC.appendChild(createNewArticle(data.title, data.date, data.firstParagraph, data.secondParagraph, data.thirdParagraph))
})