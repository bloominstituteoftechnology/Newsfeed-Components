...
class Article {
  ...
  // this.domElement.addEventListener('click', this.btnClick.bind(this));

  expandArticle(event) {
    // console.log('classlist before',this.domElement.classList)
    // Using our reference to the domElement, toggle a class to expand or hide the article.
    event.stopPropagation();
    this.domElement.classList.toggle('article-open');
    // console.log('classlist after',this.domElement.classList)
  }
}
