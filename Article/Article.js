...
function ArticleCreator(article) {
  ...
  //create paragraph elements for the body//
...
//gathing the articles//
const articles = document.querySelectorAll(".article");

//grabing the body of the html//
const body = document.querySelector("body");

//populating the body//
data.forEach(article =>
  body.appendChild(ArticleCreator(article))
);