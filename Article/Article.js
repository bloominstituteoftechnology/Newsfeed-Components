...
data.forEach(item => {
	const data_title = item.title,
		data_date = item.date,
		data_p1 = item.firstParagraph,
		data_p2 = item.secondParagraph,
		data_p3 = item.thirdParagraph;
	...
	let date = DCE("date");
	date.textContent = data_date;
	date.classList = "date";

	let text1 = DCE("p");
	text1.textContent = data_p1;
	let text2 = DCE("p");
	text2.textContent = data_p2;
	let text3 = DCE("p");
	text3.textContent = data_p3;

	let expando = DCE("span");
	expando.textContent = "More >";
	expando.classList = "expandButton";
	// clg(article.classList.length);
