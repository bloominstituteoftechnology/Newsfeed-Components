...
data.forEach(data => {
            console.log("creating data articles", data.newsArticleTitle; articlesContainer.appendChild(createArticle(data));
            });
        ...
        function createArticle(data) {
            ...
            const newsArticleDate = document.createElement('p');
            newsArticleDiv.appendChild(articleDate);
            ...
            newsArticleTitle.textContent = data.title;
            newsArticleDate.textContent = data.date;
            newsFirstParagraph.textContent = data.firstParagraph;
            newsSecondParagraph.textContent = data.secondParagraph;
            const newsThirdParagraph = document.createElement('p');
