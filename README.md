...
* Follow the instructions found in the Menu.js file to complete thce JavaScript funtionality.  NOTE: Start near the bottom of the page by looking for `const menu`.
