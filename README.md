...
* [x] Create a new branch: git checkout -b `<refactor>`.
* [ ] Implement the project on your newly created `<refactor>` branch, committing changes regularly.
* [ ] Push commits: git push origin `<refactor>`.
