...
const testingArticle = articleMaker({ title: 'This is less confusing', date: '10/27/21', firstParagraph: 'is this thing working?', secondParagraph: 'I hope it works', thirdParagraph: 'I think it works'});
console.log(testingArticle);
