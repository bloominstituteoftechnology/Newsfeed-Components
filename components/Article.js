...
function articleMaker(data) {
	...
	firstArticleParagraph.textContent = data.firstParagraph;
	secondArticleParagraph.textContent = data.secondParagraph;
	thirdArticleParagraph.textContent = data.thirdParagraphh;
