...
const data = [{
    ...
    {
        title: 'Professional Software Development 2020',
        date: 'Nov 1st, 2020',
        ...
        secondParagraph: `Animation Goal #2 Animate the article opening. This one is a bit trickier. You will need to change the CSS for this component as well. Animate the component so that it slides open and slides closed on each click. Update the text in the expand button to read 'Click to Expand' or 'Click to Close' depending on the state of the article. `,

        thirdParagraph: `Create a function that builds Article components. You are not expected to finish this. This goal is simply an exercise in thinking about how you would implement a function that took some data, created a new Article from it, and appended it to the HTML (without actually writing anything in the HTML file). This is a difficult concept to undertake, but even thinking about how you would implement it will give you a better understanding of how we use frameworks in upcoming sprints.`
    }
...
function articleMaker(article) {
    ...
    newArticle.appendChild(articleH2);
    ...
    newSpan.className = 'expandButton';
    newSpan.textContent = '+';
...
/*
  Step 2: Still inside `
    articleMaker `, add an event listener to the span.expandButton.
...
data.forEach(article => {
    const articleToAppend = articleMaker(article);
    document.querySelector('div.articles').appendChild(articleToAppend);
});
