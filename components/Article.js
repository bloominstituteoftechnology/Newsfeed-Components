...
const data = [
  ...
  // </div>
    ...
    article.appendChild(paraElem1); 
    article.appendChild(paraElem2);
    article.appendChild(paraElem3);
    ...
    paraElem1.textContent = firstParagraph;
    paraElem2.textContent = secondParagraph;
    paraElem3.textContent = thirdParagraph;
