...
const testArticle = articleMaker.apply( { title: 'this is better', date: '12/1/21', firstParagraph: 'hi there', secondParagraph: 'I hope it works', thirdParagraph: 'It has to work' } );
