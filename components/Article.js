...
function articleMaker({ title, date, firstParagraph, secondParagraph, thirdParagraph}) {
  ...
  expandButton.textContent = 'PUSH ME, YOU`LL LIKE IT';
...
const testArticle = articleMaker({ title: 'HELLO', date: '2085', firstParagraph: 'THE FUTURE', secondParagraph: 'THE PAST', thirdParagraph: 'THE NOW'});
