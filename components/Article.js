...
function articleMaker(obj) {
  ...
  const articleparagprah1 = document.createElement("p");
  const articleparagprah2 = document.createElement("p");
  const articleparagprah3 = document.createElement("p");
  const articleExpandButton = document.createElement("span");
  //using appendChild
  article.appendChild(titleOfArticle);
  article.appendChild(date);
  article.appendChild(articleparagprah1);
  article.appendChild(articleparagprah2);
  article.appendChild(articleparagprah3);
  ...
  articleparagprah1.textContent = obj.firstParagraph;
  articleparagprah2.textContent = obj.secondParagraph;
