...
function articleMaker({ title, date, firstParagraph, secondParagraph, thirdParagraph}) {
  ...
  expandButton.textContent = 'PUSH HERE PLS :)';
...
const testArticle = articleMaker({ title: 'Hello World', date: '2019', firstParagraph: 'one', secondParagraph: 'two', thirdParagraph: 'three'});
