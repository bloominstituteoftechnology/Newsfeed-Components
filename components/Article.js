...
const articleMaker = ([object]) => {
    const articleDiv = document.createElement('div');//creates a new element
    ...
    articleExpand.classList.add('expandButton');//adds a class
    articleDate.classList.add('date');//adds a class

    articleTitle.textContent = object.title;
    articleDate.textContent = object.date;
    articlePOne.textContent = object.firstParagraph;
    articlePTwo.textContent = object.secondParagraph;
    articlePThree.textContent = object.thirdParagraph;
    articleExpand.textContent = '+';//adds a '+' to the expand element
...
const articles = document.querySelector('.articles');//creates a variable holding the element with the class of .article

data.forEach(el => { 
    articles.appendChild(articleMaker([el]));//calling the articleMaker function
});//loops through the object of 'data'
