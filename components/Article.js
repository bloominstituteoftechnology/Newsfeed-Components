...
const data = [
  ...
  */
  ...
  function articleMaker({title, date, firstParagraph, secondParagraph, thirdParagraph}) {
    ...
    articleParOne.textContent = firstParagraph;
    articleParTwo.textContent = secondParagraph;
    articleParThree.textContent = thirdParagraph;
...
const articlePosts = data.map( elem => {
  return articleMaker(elem);
})
console.log(articlePosts);

articlePosts.forEach(elem => {
